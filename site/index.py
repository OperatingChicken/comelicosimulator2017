...
if index == "login":
    ...
    p.add_paragraph("PF: " + str(player_attr[0][4]) + "/" + str(player_attr[0][3]) + " | Danno: " + str(player_attr[0][5]) + " | ATT: " + str(player_attr[0][0]) + " | DIF: " + str(player_attr[0][1]) + " | PER: " + str(player_attr[0][2]))
    p.add_paragraph("FOR: " + str(player_data[0][5]) + " | INT: " + str(player_data[0][6]) + " | AGI: " + str(player_data[0][7]) + " | COS: " + str(player_data[0][8]))
    p.add_paragraph("Monete: " + str(player_data[0][9]) + " | PE: " + str(player_data[0][10]))
    p.add_newline()
